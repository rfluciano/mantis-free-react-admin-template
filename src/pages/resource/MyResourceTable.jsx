...
import MyResourceMenu from './MyResourceMenu';
...
export default function MyResourceTable({ beneficiaryMatricule, resources }) {
            ...
            {sortedAndPaginatedResources.map((resource) => {
              ...
              return (
                ...
                >
                  ...
                  <MyResourceMenu /> {/* Replace with the actual menu component */}
                </TableCell>
                </TableRow>
              );
            })}
